...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction3() {
    Function function =
        new BinaryOperationFunction(
            new BinaryOperationFunction(new NumberFunction(9), new VariableFunction("x"), "/"),
  ...
  public void shouldListVariablesFunction4() {
    Function function =
        new BinaryOperationFunction(
            new BinaryOperationFunction(new NumberFunction(27), new VariableFunction("a"), "/"),
            new VariableFunction("b"),
            "pow");
  ...
  public void shouldListVariablesFunction6() {
    Function function =
        new BinaryOperationFunction(
            new UnaryOperationFunction(new VariableFunction("value"), "mod"),
